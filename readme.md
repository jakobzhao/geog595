...
- **Practical Exercise 7:** [Environmental data collection with Raspberry Pi`Under Development` ](08_iot/pe.md). `Due: 03/08 5:00pm. However, this exercise will not be included to your final score`.
