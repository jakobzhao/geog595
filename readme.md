...
> This page is the syllabus for the course — there is no printed syllabus, just refer here instead. Please refer to this document often! Please also do feel free to ask for clarifications whenever needed.
...
- **`TBA` Practical Exercise 5:** [Place context analysis using Natural Language Processing](06_ai/pe.md) `Due: 01/07 5:00pm`.
...
- **`TBA` Practical Exercise 7:** [Environmental data collection with Raspberry Pi](08_iot/pe.md). `Due: 03/08 5:00pm. However, this exercise will not be included to your final score`.
