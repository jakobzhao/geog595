...
Also, if you want to test a smaller dataset, you can try a openly shared one named "banana" at [here](https://github.com/pierotofy/dataset_banana), or a [drone-collected image dataset (no GPS data)](https://github.com/merkato/odm_wietrznia) or [a dataset with GPS data attached](https://github.com/OpenDroneMap/odm_data_aukerman).
...
I want to express my gratitude to Oliver Nie who provided me research assistance on developing this assignment. The usual disclaims apply.